(function () {
    ...
    function ensureModal() {
        ...
        if (! document.getElementById(STORAGE_ID)) {
        ...
        ensureRoot: function (popupId) {
            ...
            loadingPopups[popupId] = fetch(renderUrl(popupId), {
                ...
                .then(function (html) {
                    ...
                    if (root && typeof window.bindCallbackForm === 'function') {
                        root.querySelectorAll("form[id='callback']").forEach(window.bindCallbackForm);
                    }
